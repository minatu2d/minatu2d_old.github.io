...
#### 3.5.2.2. Collecting and viewing a userspace trace on the target (inside a
shell)¶
...
#### 3.5.2.3. Manually copying a trace to the host and viewing it in Eclipse
...
#### 3.5.2.4. Collecting and viewing a trace in Eclipse¶
