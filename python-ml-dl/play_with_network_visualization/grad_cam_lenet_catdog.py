...
generate_gradcam_at_layer(model, "conv2d_3",
        n_class = 2, input_shape = (300,300))

generate_gradcam_at_layer(model, "conv2d_2",
        n_class = 2, input_shape = (300,300))
